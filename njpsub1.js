document.addEventListener('DOMContentLoaded', () => {
    ...
    // sub1 관람주의사항 팝업
    let alertOpenBtn1 = document.querySelector('sub1_con_menuS li:first-child');
    let alertOpenBtn3 = document.querySelector('.sub1_con_tit:last-child');
    let alertCloseBtn = document.querySelector('.sub1_popup_btn');
    let alertPopup1 = document.querySelector('#sub1_popup1_wrap');
    let alertPopup3 = document.querySelector('#sub1_popup3_wrap');
    
    alertOpenBtn1.addEventListener('mouseover', () => {
        alertPopup1.classList.add('popup_toggle');
    });
    ...
    alertCloseBtn.addEventListener('click', () => {
        alertPopup3.classList.add('popup_toggle2');  
    });
});
